...
class _SettingsScreenState extends ConsumerState<SettingsScreen>
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // TAB 1: GERAL - Sessão, Empresa, Credenciais
  // ═══════════════════════════════════════════════════════════════════════════
  ...
  Widget _buildGeneralTab() {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          // SESSÃO ATUAL
          _buildSectionHeader('Sessão Actual', Icons.person),
          Card(
            child: Padding(
              padding: const EdgeInsets.all(16),
              child: Column(
                children: [
                  ...
                  _buildInfoRow(
                    ...
                    icon: authState.isAuthenticated ? Icons.check_circle : Icons.cancel,
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // TAB 2: API - Configurações da API Moloni
  // ═══════════════════════════════════════════════════════════════════════════
                  ...
                  children: [
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: IconButton(
                          icon: Icon(_showClientSecret
                              ...
                              : Icons.visibility),
                          onPressed: () =>
                              setState(() => _showClientSecret = !_showClientSecret),
                        ),
                      ),
                      validator: (v) =>
                          v?.trim().isEmpty == true ? 'Obrigatório' : null,
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        label: Text(_isSaving ? 'A guardar...' : 'Guardar Configurações API'),
                      ),
                    ),
                  ],
                ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    const Text(
                      '• O Client ID e Client Secret são obtidos na área de programadores do Moloni\n'
                      '• A URL padrão da API é https://api.moloni.pt/v1\n'
                      '• Após alterar estas configurações, faça logout e login novamente',
                    ),
                  ],
                ),
              ),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
              ...
              child: Column(
                children: [
                  ...
                  _buildInfoRow(
                    ...
                    icon: Icons.build,
                    valueColor: kDebugMode ? Colors.orange : Colors.green,
                  ),
                ],
              ),
            ),
          ...
          // Zona de perigo
          _buildSectionHeader('Zona de Perigo', Icons.warning_amber),
          Card(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  const Text(
                    'As acções abaixo são irreversíveis. Use com cuidado.',
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      label: const Text('Repor Todas as Configurações'),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 12),
                const Expanded(child: Text('Nenhuma impressora USB encontrada')),
              ],
            ),
          )
        else
      ...
      if (reading != null) {
        ...
        setState(() {
          _testResult = 'Sem resposta da balança. Verifique:\n'
              ...
              '• Protocolo configurado na balança';
          _testSuccess = false;
        });
      }
    } catch (e) {
